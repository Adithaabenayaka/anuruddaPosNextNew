    ...
    <div className="p-6 max-w-7xl mx-auto relative min-h-[60vh]">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col transform transition-all animate-in fade-in zoom-in duration-200">
        ...
        <div className="absolute inset-0 z-[50] bg-gray-50/80 backdrop-blur-sm flex flex-col items-center justify-center rounded-3xl">
          <div className="flex flex-col items-center gap-6">
            <div className="relative">
              ...
              <Package className="absolute inset-0 m-auto text-primary-600 w-6 h-6" />
            </div>
            <p className="font-black text-primary-900 uppercase tracking-[0.3em] text-[10px]">Updating Stock</p>
          </div>
        </div>
      )}
    </div>
